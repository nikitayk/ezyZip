...
function DSASolver({ onSolve, onAnalyzeComplexity, onGenerateTestCases, onFileUpload, onFileAnalysis, isLoading, pageContext, onPullContext, onCaptureActiveImage }: DSASolverProps) {
